 ...
 *
 * Escriba un programa que dado un arreglo de caracteres letras que están ordenadas en orden ascedente y un caracter objetivo,
 * que te regrese el caracter mas pequeño en el arreglo que sea mayor que el caracter objetivo.
 *
